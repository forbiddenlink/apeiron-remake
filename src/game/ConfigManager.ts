import { ENEMIES, GRID, PLAYER, SCORING, YUMMIES } from './GameConfig'
...
export class ConfigManager {
  ...
  private constructor() {
    ...
    this.currentConfigs = savedConfigs ? JSON.parse(savedConfigs) : cloneDeep(this.defaultConfigs)
  }
  ...
  updateConfig(path: string, value: any): void {
    ...
    if (section in this.currentConfigs) {
      setNestedValue(
        this.currentConfigs[section as keyof typeof this.currentConfigs],
        rest.join('.'),
        value
      )
      this.saveConfigs()
