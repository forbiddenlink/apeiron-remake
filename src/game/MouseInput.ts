...
export class MouseInput {
  ...
  private bindEvents() {
    ...
    const onMouseMove = (e: MouseEvent) => {
      ...
      this.mouseX =
        (e.clientX - this.boundingRect.left) * (this.canvas.width / this.boundingRect.width)
      this.mouseY =
        (e.clientY - this.boundingRect.top) * (this.canvas.height / this.boundingRect.height)
  ...
  getInput(
    ...
    playerY: number,
    dt: number
  ): { vx: number; vy: number; shooting: boolean } {
