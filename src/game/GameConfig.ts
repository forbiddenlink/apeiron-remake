...
const LARRY_THE_SCOBSTER = {
  ...
  SCORE_NEAR: SCORE.SCOBSTER_NEAR,
  SCORE_MED: SCORE.SCOBSTER_MED,
  SCORE_FAR: SCORE.SCOBSTER_FAR,
...
const GORDON_THE_GECKO = {
  SPEED_PX_PER_SEC_X: SPEED.GECKO_PX_PER_SEC_X,
  SCORE: SCORE.GECKO,
  SPAWN_MIN_TIME: TIMERS.SPAWN_GECKO_MIN,
  SPAWN_MAX_TIME: TIMERS.SPAWN_GECKO_MAX,
} as const
