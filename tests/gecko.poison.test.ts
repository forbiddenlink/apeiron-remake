...
import { Gecko } from '../src/game/Enemies'
import { Grid, Mushroom } from '../src/game/Grid'

// This is a lightweight behavioral check: when a gecko passes over an existing
